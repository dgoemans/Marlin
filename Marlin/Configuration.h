...
#define STRING_CONFIG_H_AUTHOR "(GOEMANS, GOEMANS-B1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GOEMANS-B1"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 114 }
